...
const Loginpopup = ({ setShowLogin }) => {
  ...
  const onLogin = async (e) => {
    ...
    if (isAdmin) {
      ...
      window.location.href = "https://chowtime-admin.netlify.app/";
      return;
    }
    ...
    <div className='absolute z-[1] w-full h-full bg-[#00000090] grid top-0'>
      <form onSubmit={onLogin}
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="adminLogin" className="text-sm">Login as Admin</label>
        </div>

        <button 
          type='submit' 
          className='border-none p-[10px] rounded-[4px] text-white bg-[#DC143C] cursor-pointer text-[15px]'
        >
        ...
        {currentState === "Login" ? (
          <p>
            ...
            <span 
              ...
              className='font-semibold text-[#DC143C] cursor-pointer'
            >
              Click here
            </span>
          </p>
